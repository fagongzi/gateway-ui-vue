<template>
  <div class="app-container">
    <el-form ref="dataForm" :model="tempItem" label-width="180px">
          ...
          <el-col>
            ...
            <el-card class="box-card" v-show="needDefaultValue">
              ...
              <el-row class="el-margin-bottom">
                <el-col :span="4" style="text-align: right;padding-right: 8px;">
                  <span class="red-icon">*</span> 状态码:
                </el-col>
                <el-col :span="10">
                  <el-input v-model.number="tempItem.defaultValue.code" placeholder="例如：200，404，500"></el-input>
                </el-col>
              </el-row>
              <el-row class="el-margin-bottom">
                  ...
                  <template v-for="(head,index) in tempItem.defaultValue.headers">
                    <el-row style="margin-bottom: 8px">
                      ...
                      <el-col v-if="index === 0" :span="1" style="text-align: center">
                            <span title="添加" @click="addDefaultValueItem('head')" style="cursor: pointer"
                                  class="el-icon-circle-plus-outline">
                            </span>
                      </el-col>
                      <el-col v-if="index > 0" :span="1" style="text-align: center">
                            <span title="删除" @click="removeDefaultValueItem('head',index)"
                                  style="cursor: pointer" class="el-icon-remove-outline">
                            </span>
                      </el-col>
                    </el-row>
                  </template>
      ...
      <!--https 支持-->
      <el-form-item label="https支持" style="width: 800px">
        <el-row>
          <el-col>
            <el-button type="text" v-show="!needHttps" @click="needHttps = true">使用HTTPS
            </el-button>
            <el-card class="box-card" v-show="needHttps">
              <div slot="header" class="clearfix" style="line-height:25px ">
                <el-alert :closable="false"
                          title="TLS证书(key)文件内容（PEM格式，Base64编码）"
                          type="warning">
                </el-alert>
              </div>
              <el-row class="el-margin-bottom">
                <el-col :span="5" style="text-align: right;padding-right: 8px;">是否启动:</el-col>
                <el-col :span="19">
              ...
              <el-row class="el-margin-bottom">
                <el-col :span="5" style="text-align: right;padding-right: 8px;"><span class="red-icon">*</span>文件内容:
                </el-col>
                <el-col :span="19">
                  <el-input type="textarea" v-model.trim="tempItem.tlsEmbedCert.certData" rows="5"></el-input>
                </el-col>
              </el-row>
              <el-row class="el-margin-bottom">
                <el-col :span="5" style="text-align: right;padding-right: 8px;"><span class="red-icon">*</span>Key文件内容:
                </el-col>
                <el-col :span="19">
                  <el-input type="textarea" v-model.trim="tempItem.tlsEmbedCert.keyData" rows="5"></el-input>
                </el-col>
              </el-row>
            </el-card>
            <el-button type="text" v-show="needHttps" @click="needHttps = false">不使用HTTPS
            </el-button>
          </el-col>
        </el-row>
      </el-form-item>
  ...
  export default {
    ...
    watch: {
      ...
      'editItem': function (newValue, oldValue) {
        ...
        if (this.tempItem.tlsEmbedCert.certData && this.tempItem.tlsEmbedCert.keyData) {
          this.needHttps = true;
        }
    ...
    methods: {
      ...
      _formatFormData() {
        ...
        //
        if (!this.needHttps) {
          _tempItem.tlsEmbedCert.keyData = '';
          _tempItem.tlsEmbedCert.certData = '';
          _tempItem.useTLS = false;
        } else {
          if (!_tempItem.tlsEmbedCert.keyData) {
            isError = true;
            this._showMessage('请填写TLS证书Key文件内容');
          } else if (!_tempItem.tlsEmbedCert.certData) {
            isError = true;
            this._showMessage('请填写TLS证书文件内容');
          }
        }
